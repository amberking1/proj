...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    <label class="sr-only" for="icPatient">User ID</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="text" name="patientPhone" value="" class="form-control input-lg" placeholder="Your Phone Number"  required/>
                                        <input type="text" name="patientAddress" value="" class="form-control input-lg" placeholder="Your Address"  required/>
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="Your ID Number (Will be used as Login)"  required/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>This is the Doctor's availability. Please login to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
			<div class="container">
				<div class="underlined-title">
					...
					<hr>
					<h2>Feel free to contact us by phone, email or make an appointment through your account here.</h2>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12 pad25">
						...
						<div class="col-xs-10">
							<h4>Your Account</h4>
							<p>Sign Up to register your details with your Doctor and make appointments online.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12 pad25">
						<div class="col-xs-2">
						...
						<div class="col-xs-10">
							...
							<p>Search through thr calender to easily find your Doctors available appointment times that suit you.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12 pad25">
						<div class="col-xs-2">
						...
						<div class="col-xs-10">
							<h4>Contact Us</h4>
							<p>Feel free to email or phone us with any questions about you have about your appointment.      Phone: (01) 299 9999  or   Email: doctors@gmail.com</p>
						</div>
					</div>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© Appointment App</p>
                <p class="pull-right"><a href="adminlogin.php">Admin Login</a></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
